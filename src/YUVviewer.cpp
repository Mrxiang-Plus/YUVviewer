...
#define UI_GGGB2222 { .num = 4, .color = {0xff00ff00UL,0xff00ff00UL,0xff00ff00UL,0xff0000ffUL}, .bit = {2,2,2,2} }
#define UI_BBGG2222 { .num = 4, .color = {0xff0000ffUL,0xff0000ffUL,0xff00ff00UL,0xff00ff00UL}, .bit = {2,2,2,2} }
#define UI_GBBB2222 { .num = 4, .color = {0xff00ff00UL,0xff0000ffUL,0xff0000ffUL,0xff0000ffUL}, .bit = {2,2,2,2} }
#define UI_RRRG2222 { .num = 4, .color = {0xffff0000UL,0xffff0000UL,0xffff0000UL,0xff00ff00UL}, .bit = {2,2,2,2} }
#define UI_GGRR2222 { .num = 4, .color = {0xff00ff00UL,0xff00ff00UL,0xffff0000UL,0xffff0000UL}, .bit = {2,2,2,2} }
#define UI_RGGG2222 { .num = 4, .color = {0xffff0000UL,0xff00ff00UL,0xff00ff00UL,0xff00ff00UL}, .bit = {2,2,2,2} }
#define UI_BBBG2222 { .num = 4, .color = {0xff0000ffUL,0xff0000ffUL,0xff0000ffUL,0xff00ff00UL}, .bit = {2,2,2,2} }
#define UI_GGBB2222 { .num = 4, .color = {0xff00ff00UL,0xff00ff00UL,0xff0000ffUL,0xff0000ffUL}, .bit = {2,2,2,2} }
#define UI_BGGG2222 { .num = 4, .color = {0xff0000ffUL,0xff00ff00UL,0xff00ff00UL,0xff00ff00UL}, .bit = {2,2,2,2} }
