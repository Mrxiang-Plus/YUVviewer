...
<context>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;&lt;span style=&quot; font-size:24pt; font-weight:600;&quot;&gt;正在加载文件，请稍候......&lt;/span&gt;&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
</context>
<context>
    <name>YUVviewer</name>
...
3.Used in the image display interface
  ...
  - Middle click to display the original size of the image.</source>
        <translation>1.在主界面选择参数。
2.单击“打开文件或文件夹”以解析图像数据并显示图像。
3.用于图像显示界面
   - 滚轮可放大和缩小图像，
   - 使用左键拖动图像，
   - 双击左键将图像导出为png格式或其他raw格式，
   - 右键单击可重置图像大小和位置，
   - 双击右键可交换图像R、B通道显示，
